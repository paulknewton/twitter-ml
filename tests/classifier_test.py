...
def test_basic_classification():
    ...
    test_data = {"He is really smart": 1, "This is bad.": 0}
...
def test_words_with_punctuation():
    ...
    test_data = {"This is smart": 1, "This is smart.": 1}
    helper_verify_expected(test_data.keys(), test_data.values())


def test_whitespace():
    """Test that words can contain multiple spaces."""
    test_data = {"This is    smart    ": 1}
    helper_verify_expected(test_data.keys(), test_data.values())
